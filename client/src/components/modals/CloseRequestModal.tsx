...
const CloseRequestModal: React.FC<CloseRequestModalProps> = ({
  ...
  return (
    <CustomModal
      isOpen={isOpen}
      onClose={onClose}
      title={isSecondClosure ? "Confirm Final Closure of This Request" : "Are You Sure You Want to Close This Request?"}
      icon={ReopenIcon}
    >
      <div className="flex flex-col items-center gap-6 w-[339px]">
        ...
        >
          {isSecondClosure 
            ...
            : "This request has been active for 5 days. You may close it now and reopen it once later. After reopening, it must stay open for 5 days before a final, irreversible closure."}
        </p>
