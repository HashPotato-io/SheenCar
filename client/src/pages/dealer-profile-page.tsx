    ...
    <div className="min-h-screen flex flex-col w-full">
      ...
      <main className="w-full">
        ...
        <div className="bg-gray-50 py-10">
          <div className="flex md:flex-row md:px-10 flex-col md:items-start gap-6">
            {/* Dealer Logo */}
            <div className="w-full md:w-[185px] order-2 md:order-1 h-[220px] md:h-[148px] bg-neutral-800 rounded overflow-hidden relative flex-shrink-0 flex items-center justify-center">
            ...
            {/* Dealer Header Info */}
            <div className="flex-1 px-4 order-1 md:order-2">
              {/* ZIP code badge */}
              <div className=" ">
                <Badge title="ZIP Code: 10210" icon={<MapPin size={12} />} />
              </div>
              <h1 className="text-[26px] lg:text-[46px] font-['Gilroy-SemiBold'] font-normal leading-[100%] tracking-[-0.01em] align-middle text-[#171616]">
                {dealerData.name}
              </h1>
              <div className="flex items-center justify-start mt-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`w-5 h-5 ${i < Math.floor(dealerData.rating)
        ...
        <div className="mx-4 mb-10 shadow-lg md:mx-0 md:mb-0 md:shadow-none">
          <div className="flex flex-col lg:flex-row items-center md:items-start justify-center gap-4 sm:gap-6  sm:mb-[20px] sm:ml-0 lg:ml-[40px]">
            <div
              style={{
                background: "#FFFFFF",
              ...
              className="p-4 sm:p-6 md:shadow-md mb-4 lg:mb-0"
            >
            ...
            <div className="w-full max-w-[373px]">
              <div
                className="bg-white md:shadow-md rounded-lg p-4 sm:p-6"
                style={{
                  background: "#FFFFFF",
                }}
              >
        ...
        <div className="p-8 sm:py-8 bg-[#E9E9E9]">
          <div className="flex flex-row justify-between items-center mb-6">
            <h2 className="text-2xl sm:text-[32px] md:text-[40px] font-['Gilroy-SemiBold'] font-normal leading-[100%] tracking-[-0.01em] text-center sm:text-left text-black">
