            ...
            <div className="flex items-start gap-6">
              ...
              <div className="w-[128px] h-[96px] bg-neutral-800 rounded overflow-hidden relative flex-shrink-0 flex items-center justify-center">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="text-white text-xs absolute bottom-2 w-full text-center py-1 bg-green-800 font-bold">
                    CAR DEALER
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-1/2 lg:border-r lg:pr-8">
                <div className="space-y-2">
                  {[5, 4, 3, 2, 1].map((stars) => {
                    const breakdown = dealerData.reviewsBreakdown.find(b => b.stars === stars) || { stars, count: 0 };
                    const percentage = (breakdown.count / dealerData.reviewCount) * 100;
                ...
                <div className="mt-10 text-right">
                  ...
                  <div className="flex justify-end mt-1">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        className={`w-4 h-4 ${i < Math.floor(dealerData.rating) ? "fill-amber-500 text-amber-500" : "text-gray-300"}`} 
                      />
                    ))}
                  </div>
                  <div className="text-sm text-gray-500 mt-1">{dealerData.reviewCount} Reviews</div>
                </div>
              </div>
                  ...
                  {dealerData.reviews.map((review) => (
                    <div key={review.id} className="mb-6">
                      <div className="flex items-center mb-2">
                        <img src={review.avatar} alt={review.author} className="w-8 h-8 rounded-full mr-2" />
            ...
            <div className="mt-12 border-t pt-8">
              ...
              <div className="flex items-center mb-4">
                <div className="flex items-center">
                  <img src="https://randomuser.me/api/portraits/men/40.jpg" alt="John Doe" className="w-10 h-10 rounded-full mr-3" />
                ...
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg 
                      ...
                      className={`w-6 h-6 cursor-pointer ${star <= reviewRating ? "text-amber-500" : "text-gray-300"}`}
